...
import { inputsStockChange } from './mobile-stock-change-by-identifier';
...
@ui.decorators.page<MobileStockChangeByIdentifierDetails>({
    title: 'Stock change',
...
export class MobileStockChangeByIdentifierDetails extends ui.Page<GraphApi> {
    /*
    ...
    @ui.decorators.textField<MobileStockChangeByIdentifierDetails>({
        isDisabled: true,
        isTransient: true,
        prefix: 'Site',
    })
    ...
    @ui.decorators.pageAction<MobileStockChangeByIdentifierDetails>({
        title: 'Next',
        shortcut: ['f2'],
            ...
            if (!this.stock.selectedRecords.length) {
                ...
                if (this.stock.value.length) {
                    if (!isProductGlobalReceivedIssuedInStock(this)) {
                        ...
                        this.$.storage.set('mobile-stockChangeByIdentifier', JSON.stringify(savedInputs));
                        onGoto(this, '@sage/x3-stock/MobileStockChangeByIdentifierDestination', {
                        ...
                        this._notifier.show(
                            ui.localize(
                                '@sage/x3-stock/pages__mobile_stock_change_by_identifier_lines__notification__product_is_global_serial_number_managed',
                    ...
                    this._notifier.show(
                        ui.localize(
                            '@sage/x3-stock/pages__mobile_stock_change_by_identifier_lines__notification__stock_is_empty',
                ...
                await dialogMessage(
                    ...
                    ui.localize(
                        '@sage/x3-stock/pages__mobile_stock_change_by_identifier_lines__notification__no_stock_error',
            ...
            if (!errors.length) {
                ...
                if (currentRecord?.product?.product?.serialNumberManagementMode === 'globalReceivedIssued') {
                    if (!this.serialNumberLines.value.length) {
                        throw new Error(
                            '@sage/x3-stock/pages__mobile_stock_change_by_identifier_lines__notification__error_startingSerialNumberMandatory',
                        );
                    }
                    ...
                    await dialogMessage(
                        ...
                        ui.localize('@sage/x3-stock/dialog-error-title', 'Error'),
                        ui.localize(
                            '@sage/x3-stock/pages__mobile_stock_change_by_identifier_lines__quantityInPackingUnitDestination_must_be_greater_than_0',
                ...
                if (Number(this.quantityToMove.value) > Number((currentRecord as any).quantityInPackingUnitRest)) {
                    await dialogMessage(
                        ...
                        ui.localize('@sage/x3-stock/dialog-error-title', 'Error'),
                        `${ui.localize(
                            '@sage/x3-stock/pages__mobile_stock_change_by_identifier_lines__enter_a_quantity_less_than_or_equal_to_the_stock_quantity',
    ...
    @ui.decorators.pageAction<MobileStockChangeByIdentifierDetails>({
        ...
        onError(error) {
            switch (error.message) {
                case '@sage/x3-stock/pages__mobile_stock_change_by_identifier_lines__notification__error_startingSerialNumber': {
                    return ui.localize(
                        '@sage/x3-stock/pages__mobile_stock_change_by_identifier_lines__notification__error_startingSerialNumber',
                ...
                case '@sage/x3-stock/pages__mobile_stock_change_by_identifier__same-amount-serial-numbers-in-the-range-to-match-quantity-to-move': {
                    return ui.localize(
                        '@sage/x3-stock/pages__mobile_stock_change_by_identifier__same-amount-serial-numbers-in-the-range-to-match-quantity-to-move',
    ...
    @ui.decorators.section<MobileStockChangeByIdentifierDetails>({
        isTitleHidden: true,
    })
    ...
    @ui.decorators.block<MobileStockChangeByIdentifierDetails>({
        isTitleHidden: true,
        width: 'extra-large',
        parent() {
    ...
    @ui.decorators.referenceField<MobileStockChangeByIdentifierDetails, Product>({
        parent() {
        ...
        columns: [
            ...
            ui.nestedFields.reference<MobileStockChangeByIdentifierDetails, Product, UnitOfMeasure>({
    ...
    @ui.decorators.referenceField<MobileStockChangeByIdentifierDetails, LotsSites>({
        parent() {
            return this.bodyBlock;
        },
        title: 'Lot',
    ...
    @ui.decorators.referenceField<MobileStockChangeByIdentifierDetails, SerialNumber>({
        parent() {
            return this.bodyBlock;
        },
        title: 'Serial number',
    ...
    @ui.decorators.referenceField<MobileStockChangeByIdentifierDetails, Location>({
        parent() {
            return this.bodyBlock;
        },
        title: 'Location',
    ...
    @ui.decorators.referenceField<MobileStockChangeByIdentifierDetails, LicensePlateNumber>({
        parent() {
            return this.bodyBlock;
        },
    ...
    @ui.decorators.selectField<MobileStockChangeByIdentifierDetails>({
        parent() {
            return this.bodyBlock;
        },
        title: 'Status',
    ...
    @ui.decorators.numericField<MobileStockChangeByIdentifierDetails>({
        parent() {
            return this.bodyBlock;
        },
    ...
    @ui.decorators.switchField<MobileStockChangeByIdentifierDetails>({
        parent() {
            return this.bodyBlock;
        },
        title: 'Select all',
    ...
    @ui.decorators.separatorField<MobileStockChangeByIdentifierDetails>({
        parent() {
            return this.bodyBlock;
        },
        isFullWidth: true,
    ...
    @ui.decorators.tableField<MobileStockChangeByIdentifierDetails, Stock>({
        parent() {
            return this.bodyBlock;
        },
        ...
        columns: [
            ...
            ui.nestedFields.reference<MobileStockChangeByIdentifierDetails, Stock, ProductSite>({
                bind: 'product',
            ...
            ui.nestedFields.reference<MobileStockChangeByIdentifierDetails, Stock, LicensePlateNumber>({
            ...
            ui.nestedFields.reference<MobileStockChangeByIdentifierDetails, Stock, Location>({
                bind: 'location',
                valueField: 'code',
                node: '@sage/x3-stock-data/Location',
                isReadOnly: true,
            ...
            ui.nestedFields.reference<MobileStockChangeByIdentifierDetails, Stock, StockStatus>({
                bind: 'status',
                valueField: 'code',
            ...
            ui.nestedFields.technical<MobileStockChangeByIdentifierDetails, Stock, UnitOfMeasure>({
                bind: 'packingUnit',
                node: '@sage/x3-master-data/UnitOfMeasure',
                nestedFields: [
                    ui.nestedFields.text({
            ...
            ui.nestedFields.technical<MobileStockChangeByIdentifierDetails, Stock, Lot>({
                bind: 'lotReference',
    ...
    @ui.decorators.detailListField<MobileStockChangeByIdentifierDetails, Stock>({
        parent() {
        ...
        fields: [
            ...
            ui.nestedFields.reference<MobileStockChangeByIdentifierDetails, Stock, Lot>({
                node: '@sage/x3-stock-data/Lot',
                bind: 'lotReference',
            ...
            ui.nestedFields.reference<MobileStockChangeByIdentifierDetails, Stock, UnitOfMeasure>({
                bind: 'packingUnit',
                node: '@sage/x3-master-data/UnitOfMeasure',
                valueField: 'code',
                title: 'Unit',
    ...
    @ui.decorators.numericField<MobileStockChangeByIdentifierDetails>({
        ...
        scale() {
            return (this.stock.getRecordValue(this._selectedLineId) as any)?.packingUnit?.numberOfDecimals ?? 0;
        },
        async onChange() {
            const _currentRecord = this.stock.getRecordValue(this._selectedLineId);
            if (_currentRecord) {
    ...
    @ui.decorators.tableField<MobileStockChangeByIdentifierDetails>({
        parent() {
    ...
    private async _init() {
        ...
        if (Number(_savedInputs?.stockChange?.stockChangeLines?.length) > 0) {
    ...
    private _getSavedInputs(): inputsStockChange {
        return JSON.parse(this.$.storage.get('mobile-stockChangeByIdentifier') as string) as inputsStockChange;
    }
    ...
    private async _onSearch(filter: Filter<Stock>) {
        ...
        const _filter = await onChangeFilterStock(this, filter);
        const _stockFilter = await onRemoveLpnFilter(this, _filter);
        this.stock.value = await getStockResults(this, _stockFilter);
